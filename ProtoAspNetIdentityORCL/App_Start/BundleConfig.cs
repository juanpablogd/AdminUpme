    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                "~/Scripts/app/js/jquery.js",
                "~/Scripts/app/js/bootstrap.min.js",
                "~/Scripts/app/js/jquery.prettyPhoto.js",
                "~/Scripts/app/js/jquery.isotope.min.js",
                "~/Scripts/app/js/main.js",
                "~/Scripts/app/js/search.js",
                "~/Scripts/app/Main.js"));
