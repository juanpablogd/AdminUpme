    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Intento invalido de Logueo.");
                    return View(model);
            }
        }

        private Task SignInAsync(ApplicationUser user, bool p)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //JP await SignInManager.SignInAsync(user, isPersistent:false, rememberBrowser:false);
        ...
        public ActionResult LogOff()
        {
            ...
            GlobalVariables.idUsuario = null;
            GlobalVariables.idOrganizacion = null;
